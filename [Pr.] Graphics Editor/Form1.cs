...
namespace _Pr.__Graphics_Editor
{
    public partial class Form1 : Form
    {
        ...
        {
            if (col1var == true) brcolor1.BackColor = CBlack.BackColor;
            if (col2var == true) brcolor2.BackColor = CBlack.BackColor;
        }

        private void CWhite_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CWhite.BackColor;
            if (col2var == true) brcolor2.BackColor = CWhite.BackColor;
        }

        private void CDimGray_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CDimGray.BackColor;
            if (col2var == true) brcolor2.BackColor = CDimGray.BackColor;
        }

        private void CDarkGray_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CDarkGray.BackColor;
            if (col2var == true) brcolor2.BackColor = CDarkGray.BackColor;
        }

        private void CMaroon_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CMaroon.BackColor;
            if (col2var == true) brcolor2.BackColor = CMaroon.BackColor;
        }

        private void CSienna_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CSienna.BackColor;
            if (col2var == true) brcolor2.BackColor = CSienna.BackColor;
        }

        private void CRed_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CRed.BackColor;
            if (col2var == true) brcolor2.BackColor = CRed.BackColor;
        }

        private void CPink_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CPink.BackColor;
            if (col2var == true) brcolor2.BackColor = CPink.BackColor;
        }

        private void COrange_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = COrange.BackColor;
            if (col2var == true) brcolor2.BackColor = COrange.BackColor;
        }

        private void CLightOrange_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CLightOrange.BackColor;
            if (col2var == true) brcolor2.BackColor = CLightOrange.BackColor;
        }

        private void CYellow_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CYellow.BackColor;
            if (col2var == true) brcolor2.BackColor = CYellow.BackColor;
        }

        private void CKhaki_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CKhaki.BackColor;
            if (col2var == true) brcolor2.BackColor = CKhaki.BackColor;
        }

        private void CForestGreen_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CForestGreen.BackColor;
            if (col2var == true) brcolor2.BackColor = CForestGreen.BackColor;
        }

        private void CGreenYellow_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CGreenYellow.BackColor;
            if (col2var == true) brcolor2.BackColor = CGreenYellow.BackColor;
        }

        private void CDodgerBlue_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CDodgerBlue.BackColor;
            if (col2var == true) brcolor2.BackColor = CDodgerBlue.BackColor;
        }

        private void CLightSkyBlue_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CLightSkyBlue.BackColor;
            if (col2var == true) brcolor2.BackColor = CLightSkyBlue.BackColor;
        }

        private void CRoyalBlue_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CRoyalBlue.BackColor;
            if (col2var == true) brcolor2.BackColor = CRoyalBlue.BackColor;
        }

        private void CSteelBlue_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CSteelBlue.BackColor;
            if (col2var == true) brcolor2.BackColor = CSteelBlue.BackColor;
        }

        private void CPurple_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CPurple.BackColor;
            if (col2var == true) brcolor2.BackColor = CPurple.BackColor;
        }

        private void CPlum_Click(object sender, EventArgs e)
        {
            if (col1var == true) brcolor1.BackColor = CPlum.BackColor;
            if (col2var == true) brcolor2.BackColor = CPlum.BackColor;
        }
